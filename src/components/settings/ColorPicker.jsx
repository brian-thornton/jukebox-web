...
import { Button, Card, Container, Row, Col, Tab, Tabs } from 'react-bootstrap';
...
function ColorPicker({
  ...
  const picker = (color, width, handler) => <ChromePicker width={width} color={color} onChangeComplete={handler} />;
